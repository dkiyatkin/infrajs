...
* [Описание работы](https://github.com/dkiyatkin/infrajs/wiki/description)
* [Установка и запуск](https://github.com/dkiyatkin/infrajs/wiki/getting-started).

**Слой** — объект описывающий правила для вставки html, js, css и других элементов в существующий документ.

**Контроллер слоев** — `infra.index` массив или объект, представляет собой один родительский слой, или массив родительских слоев.

## Документацция
Подробное описание в [wiki] проекта, так же есть автоматически создаваемое [API](https://github.com/dkiyatkin/infrajs/blob/master/doc/README.md).
